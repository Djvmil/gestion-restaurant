...
Route::group(['prefix' => 'settings'], function () {
    ...
    Route::post('/deliverymen-settings', [DeliveryMenCheckController::class, 'index']); //get delivery men info
    Route::get('/deliverymen-menu-info', [DeliveryMenCheckController::class, 'getCheckData']); //get get delivery men info
});
